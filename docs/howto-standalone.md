...
* **Docker statt systemd:** `docker compose up -d` mit dem Multi-Arch-Image `ghcr.io/robertherter/microems:3.8.0`; die Kalibrierungs-Timer sind im Container enthalten.
