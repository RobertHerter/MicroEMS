...
button,.button{border:1px solid var(--line);border-radius:var(--r-ctl);background:var(--soft);color:var(--text);padding:8px 12px;font:inherit;cursor:pointer}button.primary{background:var(--blue);border-color:var(--blue);color:white;font-weight:700}button.danger{color:var(--bad)}button:disabled{opacity:.55;cursor:wait}
main{max-width:1500px;margin:auto;padding:16px 18px 100px}.notice{padding:11px 13px;border:1px solid var(--warn);background:#fff7da;color:var(--warn);border-radius:var(--r-ctl);margin-bottom:12px}html.dark .notice{background:#3a3219;color:#e5cb74;border-color:#6a5925}
