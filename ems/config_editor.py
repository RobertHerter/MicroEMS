...
html.dark{color-scheme:dark;--bg:#10171e;--card:#18212b;--text:#e7edf4;--muted:#a3b0bd;--line:#33414f;--shadow:0 1px 2px rgba(0,0,0,.30),0 4px 16px rgba(0,0,0,.28);--input:#202e3a;--blue:#338be0;--soft:#202e3a;--surface:#202b36;--muted-2:#b6c2ce;--focus:#4ea1f0;--bad:#ff8c87;--ok:#75ce91;--warn:#e5cb74}
