...
<style>
:root{color-scheme:light;--bg:#eef2f6;--card:#fff;--text:#20252b;--muted:#656e79;--line:#e3e8ee;--r-card:14px;--r-ctl:9px;--s0:2px;--s1:4px;--s2:8px;--s3:12px;--s4:16px;--s5:24px;--t0:10px;--t1:12px;--t2:14px;--t3:17px;--t4:22px;--shadow:0 1px 2px rgba(20,35,55,.05),0 4px 16px rgba(20,35,55,.06);--input:#fff;--blue:#1769c2;--soft:#f5f7f9;--surface:#f7f9fb;--muted-2:#59616b;--focus:#1769c2;--bad:#b52d28;--ok:#217a41;--warn:#8a6d1f}
