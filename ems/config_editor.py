...
.top-in{max-width:1500px;margin:auto;padding:var(--s3) var(--s4);display:flex;align-items:center;gap:var(--s3)}.back{color:var(--blue);text-decoration:none;font-weight:700}.title{flex:1}.title h1{font-size:var(--t3);margin:0}.title small{color:var(--muted)}
...
main{max-width:1500px;margin:auto;padding:var(--s4) var(--s4) 100px}.notice{padding:var(--s3) var(--s3);border:1px solid var(--warn);background:#fff7da;color:var(--warn);border-radius:var(--r-ctl);margin-bottom:var(--s3)}html.dark .notice{background:#3a3219;color:#e5cb74;border-color:#6a5925}
