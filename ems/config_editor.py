...
<style>
:root{color-scheme:light;--bg:#eef2f6;--card:#fff;--text:#20252b;--muted:#6b7480;--line:#e3e8ee;--r-card:14px;--r-ctl:9px;--shadow:0 1px 2px rgba(20,35,55,.05),0 4px 16px rgba(20,35,55,.06);--input:#fff;--blue:#1769c2;--soft:#f5f7f9;--danger:#b52d28;--ok:#258448}
html.dark{color-scheme:dark;--bg:#10171e;--card:#18212b;--text:#e7edf4;--muted:#9aa7b4;--line:#33414f;--shadow:0 1px 2px rgba(0,0,0,.30),0 4px 16px rgba(0,0,0,.28);--input:#202e3a;--blue:#338be0;--soft:#202e3a;--danger:#ff8c87;--ok:#75ce91}
...
button,.button{border:1px solid var(--line);border-radius:var(--r-ctl);background:var(--soft);color:var(--text);padding:8px 12px;font:inherit;cursor:pointer}button.primary{background:var(--blue);border-color:var(--blue);color:white;font-weight:700}button.danger{color:var(--danger)}button:disabled{opacity:.55;cursor:wait}
main{max-width:1500px;margin:auto;padding:16px 18px 100px}.notice{padding:11px 13px;border:1px solid #e1b74a;background:#fff7da;color:#735b11;border-radius:var(--r-ctl);margin-bottom:12px}html.dark .notice{background:#3a3219;color:#e5cb74;border-color:#6a5925}
.tools{display:grid;grid-template-columns:minmax(220px,1fr) auto;gap:10px;margin-bottom:12px}.tools input{width:100%}
details.panel{background:var(--card);border:1px solid var(--line);border-radius:var(--r-card);margin:9px 0;overflow:hidden;box-shadow:var(--shadow)}details.panel>summary{list-style:none;padding:14px 16px;cursor:pointer;display:flex;align-items:center;gap:10px}details.panel>summary::-webkit-details-marker{display:none}.panel-title{font-weight:750;font-size:16px}.panel-desc{display:block;color:var(--muted);font-size:12px;margin-top:3px}.panel-count{margin-left:auto;color:var(--muted);font-size:12px}.panel-body{border-top:1px solid var(--line);padding:14px}
...
input,select,textarea{width:100%;border:1px solid var(--line);border-radius:var(--r-ctl);background:var(--input);color:var(--text);padding:8px 9px;font:inherit}input[type=checkbox]{width:22px;height:22px;accent-color:var(--blue)}.bool-wrap{min-height:38px;display:flex;align-items:center}.secret-wrap{display:flex;gap:5px}.secret-wrap button{padding:5px 9px}
fieldset.group{border:1px solid var(--line);border-radius:var(--r-ctl);margin:10px 0;padding:8px 11px 11px}fieldset.group>legend{padding:0 7px;font-weight:700}.group-actions,.item-actions,.load-add{display:flex;gap:7px;justify-content:flex-end;margin-top:8px}.list-item,.load-card{border:1px solid var(--line);background:var(--soft);border-radius:var(--r-ctl);padding:10px;margin:8px 0}.load-head{display:flex;align-items:center;gap:8px}.load-head b{flex:1;font-size:15px}.badge{font-size:11px;color:var(--blue);border:1px solid color-mix(in srgb,var(--blue) 55%,var(--line));border-radius:20px;padding:3px 7px}
.array-scalar{display:grid;grid-template-columns:1fr auto;gap:6px;margin:5px 0}.empty{color:var(--muted);padding:8px}.status{position:fixed;z-index:25;left:50%;bottom:18px;transform:translateX(-50%);width:min(920px,calc(100% - 24px));display:flex;align-items:center;gap:10px;padding:11px 13px;background:var(--card);border:1px solid var(--line);border-radius:var(--r-card);box-shadow:0 8px 30px #0003}.status-text{flex:1}.status-text small{display:block;color:var(--muted);margin-top:2px}.status.ok{border-color:#64b87d}.status.err{border-color:#d56b67}.hidden{display:none!important}
