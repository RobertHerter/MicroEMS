...
```bash
ghcr.io/robertherter/microems:3.5.0
```
...
cd ~/microems
curl -fsSL \
  https://raw.githubusercontent.com/RobertHerter/MicroEMS/v3.5.0/config.example.yaml \
...
x-microems: &microems
  image: ghcr.io/robertherter/microems:${MICROEMS_TAG:-3.5.0}
