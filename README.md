...
```bash
ghcr.io/robertherter/microems:2.5.1
```
...
cd ~/microems
curl -fsSL \
  https://raw.githubusercontent.com/RobertHerter/MicroEMS/v2.5.1/config.example.yaml \
...
x-microems: &microems
  image: ghcr.io/robertherter/microems:${MICROEMS_TAG:-2.5.1}
